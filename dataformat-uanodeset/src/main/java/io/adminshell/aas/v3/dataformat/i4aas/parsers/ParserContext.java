...
public class ParserContext {
	...
	protected Predicate<? super Reference> hasComponent() {
		return typeOf(UaIdentifier.HasComponent);
	}

	protected Predicate<? super Reference> hasProperty() {
		return typeOf(UaIdentifier.HasProperty);
	}

	protected Predicate<? super Reference> typeOf(UaIdentifier id) {
