...
import de.fraunhofer.iais.eis.AssetAdministrationShellEnvironmentMixin;
...
public class JsonAasDeserializer {

    private final ObjectMapper mapper = new ObjectMapper();

    public JsonAasDeserializer() {
        ...
        // cannot be used as AssetAdministrationShellEnvironment is not serialized with type info
        ...
        module.addDeserializer(Referable.class, new UnwrapTypeInfoDeserializer());
