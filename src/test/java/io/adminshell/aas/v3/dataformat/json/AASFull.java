...
public class AASFull {
    ...
    public static final AssetAdministrationShell AAS_1 = new DefaultAssetAdministrationShellBuilder()
            ...
            .derivedFrom(new DefaultReferenceBuilder()
                    .keys(List.of(new DefaultKeyBuilder()
                    ...
                    .build())
            .assetInformation(
                    new DefaultAssetInformationBuilder()
    ...
    public static final AssetAdministrationShell AAS_4 = new DefaultAssetAdministrationShellBuilder()
            ...
            .assetInformation(
                    new DefaultAssetInformationBuilder()
                            ...
                            .build())
            .submodels(
                    List.of(new DefaultReferenceBuilder()
                            .keys(List.of(new DefaultKeyBuilder()
                                    .type(KeyElements.SUBMODEL)
            ...
            .views(List.of(
                    new DefaultViewBuilder()
                            .idShort("ExampleView")
                            .containedElements(List.of((new DefaultReferenceBuilder()
                                    .keys(List.of(new DefaultKeyBuilder()
                                            .type(KeyElements.SUBMODEL)
                                            .value("https://acplt.org/Test_Submodel_Missing")
                                            .idType(KeyType.IRI)
    ...
    public static final Submodel SUBMODEL_1 = new DefaultSubmodelBuilder()
            ...
            .submodelElements(List.of(
                    new DefaultPropertyBuilder()
                            .idShort("ManufacturerName").descriptions(List.of(
    ...
    public static final Submodel SUBMODEL_3 = new DefaultSubmodelBuilder()
            ...
            .semanticId(new DefaultReferenceBuilder()
                    ...
                    .build())
            .submodelElements(List.of(
                    new DefaultRelationshipElementBuilder()
                    ...
                    new DefaultOperationBuilder()
                            ...
                            .semanticId(new DefaultReferenceBuilder()
                                    ...
                                    .build())
                            .inputVariables(
                                    List.of(new DefaultOperationVariableBuilder()
                    ...
                    new DefaultSubmodelElementCollectionBuilder()
                            ...
                            .values(List.of(
                                    new DefaultBlobBuilder()
                                            ...
                                            .semanticId(new DefaultReferenceBuilder()
                                                    .keys(List.of(new DefaultKeyBuilder().type(KeyElements.GLOBAL_REFERENCE)
                                            ...
                                            .value(new DefaultPropertyBuilder()
                                                    ...
                                                    .semanticId(new DefaultReferenceBuilder()
                                                            .keys(List.of(new DefaultKeyBuilder()
                                                                    ...
                                                                    .build()))
                                                            .build())
                                                    .qualifiers(List.of(new DefaultQualifierBuilder()
                                                            .valueType("string")
                                                            .type("http://acplt.org/Qualifier/ExampleQualifier")
                                                            .build()))
                                                    .value("exampleValue")
            ...
            .submodelElements(List.of(
                    ...
                    new DefaultOperationBuilder()
                            ...
                            .semanticId(new DefaultReferenceBuilder()
                                    ...
                                    .build())
                            .kind(ModelingKind.TEMPLATE)
                            .inputVariables(List.of(new DefaultOperationVariableBuilder()
                                    .value(new DefaultPropertyBuilder()
                                            .idShort("ExampleProperty")
                                            .category("CONSTANT")
                                            .descriptions(List.of(
                                            ...
                                            .build())
                                    .build()))
                            .outputVariables(List.of(new DefaultOperationVariableBuilder()
                                    .value(new DefaultPropertyBuilder()
                                            .idShort("ExampleProperty")
                                            .category("CONSTANT")
                                            .descriptions(List.of(
                                            ...
                                            .build())
                                    .build()))
                            .inoutputVariables(List.of(new DefaultOperationVariableBuilder()
                                    .value(new DefaultPropertyBuilder()
                                            .idShort("ExampleProperty")
                                            .category("CONSTANT")
                                            .descriptions(List.of(
    ...
    public final static ConceptDescription CONCEPT_DESCRIPTION_1 = new DefaultConceptDescriptionBuilder()
            ...
            .descriptions(
                    List.of(new LangString("An example concept description  for the test application", "en-us"),
            ...
            .administration(new DefaultAdministrativeInformationBuilder()
                    ...
                    .revision("0")
                    .build())
            .isCaseOfs(List.of(new DefaultReferenceBuilder()
                    .keys(List.of(new DefaultKeyBuilder()
                            .type(KeyElements.GLOBAL_REFERENCE)
                            .idType(KeyType.IRI)
            ...
            .isCaseOfs(
                    List.of(new DefaultReferenceBuilder()
                            .keys(List.of(new DefaultKeyBuilder()
                                    ...
                                    .build()))
                            .build()))
            .embeddedDataSpecifications(List.of(new DefaultDataSpecificationBuilder()
                    .dataSpecificationContent(new DefaultDataSpecificationIEC61360Builder()
                            ...
                            .valueList(new DefaultValueListBuilder()
                                    .valueReferencePairTypes(List.of(
