...
public class ConstraintCollectionMapper implements Aas2AmlElementMapper<Collection<Constraint>> {

    @Override
    public void map(Collection<Constraint> value, AmlGenerator generator, Aas2AmlMappingContext context) throws MappingException {
