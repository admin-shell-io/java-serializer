...
public class ReferenceCollectionMapper implements Aas2AmlElementMapper<Collection<Reference>> {

    @Override
    public void map(Collection<Reference> value, AmlGenerator generator, Aas2AmlMappingContext context) throws MappingException {
