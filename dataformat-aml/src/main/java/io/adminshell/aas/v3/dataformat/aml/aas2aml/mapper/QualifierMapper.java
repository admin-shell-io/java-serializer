...
public class QualifierMapper extends DefaultMapper<Qualifier> {
    ...
    @Override
    public void map(Qualifier value, AmlGenerator generator, Aas2AmlMappingContext context) throws MappingException {
        asAttribute(value, generator, context);
    }

    @Override
    protected String getAttributeName(Qualifier value, Aas2AmlMappingContext context) {
