...
public class IdentificationModelToAttributeConverter extends CustomConverter<Reference, Attribute> {
    ...
    public Attribute convert(Reference source, Type<? extends Attribute> destinationType, MappingContext mappingContext) {
        return new Attribute(
                ...
                new RefSemantic(AASNamespace.Asset_AssetIdentificationModel.getRefSemantic()),
                null
        );
    }
}
