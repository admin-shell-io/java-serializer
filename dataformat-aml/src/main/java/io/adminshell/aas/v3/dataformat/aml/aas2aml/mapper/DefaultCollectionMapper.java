...
public class DefaultCollectionMapper<T> extends DefaultMapper<Collection<T>> {
    ...
    @Override
    protected Class<T> getType(Collection<T> collection, Aas2AmlMappingContext context) {
    ...
    @Override
    protected void asInternalElement(Collection<T> collection, AmlGenerator generator, Aas2AmlMappingContext context) throws MappingException {
    ...
    @Override
    protected void mapProperties(Collection<T> collection, AmlGenerator generator, Aas2AmlMappingContext context) throws MappingException {
    }

    @Override
    protected void asAttribute(Collection<T> collection, AmlGenerator generator, Aas2AmlMappingContext context) throws MappingException {
        if (collection != null && !collection.isEmpty()) {
